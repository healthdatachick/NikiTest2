...
response = table_service.create_table('itemstable3')
if response == True:
    print('Storage Table: itemstable3 created successfully.\n')
else:
...
cars.color = 'Silver'
cars.price = 2400
table_service.insert_entity('itemstable3', cars)
...
coffee.size = 'Small'
coffee.price = 4.50
table_service.insert_entity('itemstable3', coffee)
...
items = table_service.query_entities('itemstable3', filter="PartitionKey eq 'cardealership'", select='make,model,year,color,price')
for item in items:
    print('Make: ' + item.make)
    print('Price: ' + str(item.price) + '\n')

items = table_service.query_entities('itemstable3', filter="PartitionKey eq 'coffeeshop'", select='brand,flavor,milktype,size,price')
for item in items:
...
response = table_service.delete_table('itemstable3')
if response == True:
    print('Storage table: itemstable3 deleted successfully.')
else:
